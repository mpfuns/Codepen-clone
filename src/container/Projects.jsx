  ...
  <div className='bg-primary w-full h-full rounded-md overflow-hidden' style={{overflow: 'hidden', height: '100%' }}>
          ...
          <div className='flex items-center justify-start gap-3 w-full'>
            ...
            {project?.user?.photoURL?
              (<>
                <motion.img whileHover={{scale: 1.2}} className=" w-full h-full object-cover" src={project?.user?.photoURL} alt=""  referrerPolicy='no-referrer'/>
               </>) :  
            ...
            {/* name */}
            <div>
            <p className=' text-primaryText text-lg capitalize'>{project?.title}</p>
